...
const buttonVariants = cva(
  "flex h-11 items-center justify-center rounded-md text-sm font-bold transition-colors focusvisiblering disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary:
