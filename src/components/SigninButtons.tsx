...
export function SigninButtons() {
  ...
  return (
    <div className="bg-white p-4 shadow-md">
      ...
      <p className="mt-3 w-64 text-center font-serif text-sm text-neutral-600">
        By signing in, you agree to our <br />
        <Link className="text-neutral-600 underline decoration-solid hover:text-neutral-500" href="/terms">
          Terms of Service
        </Link>{" "}
        and{" "}
        <Link className="text-neutral-600 underline decoration-solid hover:text-neutral-500" href="/privacy">
          Privacy Policy
        </Link>
      </p>
    </div>
